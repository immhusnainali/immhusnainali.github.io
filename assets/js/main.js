...
const languageTargets = [
  ...
  { key: "workCard5Title", selector: ".work__card:nth-child(5) .work__title" },
  {
    key: "workDemoButton",
    selector: ".work__button:not([data-tools-entry])",
    property: "innerHTML",
  },
  { key: "workToolsButton", selector: "[data-tools-entry]", property: "innerHTML" },
  { key: "toolsSpotlightEyebrow", selector: "[data-tools-spotlight-eyebrow]" },
  { key: "toolsSpotlightTitle", selector: "[data-tools-spotlight-title]" },
  { key: "toolsSpotlightText", selector: "[data-tools-spotlight-text]" },
  { key: "toolsSpotlightLive", selector: "[data-tools-spotlight-live]" },
  { key: "toolsSpotlightPages", selector: "[data-tools-spotlight-pages]" },
  { key: "toolsSpotlightButton", selector: "[data-tools-spotlight-button]" },
  ...
  { key: "footerTools", selector: ".footer__item:nth-child(5) .footer__link" },
  { key: "footerContact", selector: ".footer__item:nth-child(6) .footer__link" },
...
const translations = {
  en: {
    ...
    aboutCompletedSubtitle: "50+ Projects",
    aboutSupportTitle: "Support",
    aboutSupportSubtitle: "Online 24/7",
    aboutDescription:
      "I am a Software Engineer focused on building polished web experiences, practical desktop applications, and reliable digital solutions. With hands-on experience across design and development, I have delivered 50+ projects while keeping performance, usability, and clean execution at the center of my work.",
    ...
    workCard5Title: "Browser Tools Hub",
    workDemoButton: "Demo <i class='bx bx-right-arrow work__icon'></i>",
    workToolsButton: "Explore <i class='bx bx-right-arrow work__icon'></i>",
    toolsSpotlightEyebrow: "Browser-first toolkit",
    toolsSpotlightTitle: "Browser Tools Hub",
    toolsSpotlightText:
      "Fast PDF, image, developer, text, and utility tools that run locally in your browser.",
    toolsSpotlightLive: "Live browser tools",
    toolsSpotlightPages: "Static tool pages",
    toolsSpotlightButton: "Open Tools Hub",
  ...
  ur: {
    ...
    aboutSupportSubtitle: "Online 24/7",
    aboutDescription:
      "Main aik Software Engineer hoon jo polished web experiences, practical desktop applications aur reliable digital solutions banata hoon. Design aur development dono mein hands-on tajurbe ke sath main 50+ projects deliver kar chuka hoon aur hamesha performance, usability aur clean execution ko ahmiyat deta hoon.",
    ...
    workToolsButton: "Tools dekhein <i class='bx bx-right-arrow work__icon'></i>",
    toolsSpotlightEyebrow: "Browser-first toolkit",
    toolsSpotlightTitle: "Browser Tools Hub",
    toolsSpotlightText:
      "Fast PDF, image, developer, text aur utility tools jo browser mein locally chalte hain.",
    toolsSpotlightLive: "Live browser tools",
    toolsSpotlightPages: "Static tool pages",
    toolsSpotlightButton: "Tools Hub kholein",
  ...
  es: {
    ...
    aboutCompletedSubtitle: "50+ Proyectos",
    aboutSupportTitle: "Soporte",
    aboutSupportSubtitle: "En linea 24/7",
    aboutDescription:
      "Soy un Ingeniero de Software enfocado en crear experiencias web pulidas, aplicaciones de escritorio practicas y soluciones digitales confiables. Con experiencia real en diseno y desarrollo, he entregado mas de 50 proyectos manteniendo el rendimiento, la usabilidad y una ejecucion limpia como prioridad.",
    ...
    workCard5Title: "Centro de Herramientas",
    workDemoButton: "Demo <i class='bx bx-right-arrow work__icon'></i>",
    workToolsButton: "Explorar <i class='bx bx-right-arrow work__icon'></i>",
    toolsSpotlightEyebrow: "Kit de herramientas en navegador",
    toolsSpotlightTitle: "Centro de Herramientas",
    toolsSpotlightText:
      "Herramientas rapidas de PDF, imagen, desarrollo, texto y utilidad que funcionan localmente en tu navegador.",
    toolsSpotlightLive: "Herramientas activas",
    toolsSpotlightPages: "Paginas estaticas",
    toolsSpotlightButton: "Abrir herramientas",
  ...
  fr: {
    ...
    aboutCompletedSubtitle: "50+ Projets",
    aboutSupportTitle: "Support",
    aboutSupportSubtitle: "En ligne 24/7",
    aboutDescription:
      "Je suis un Ingenieur Logiciel concentre sur la creation d'experiences web soignees, d'applications desktop pratiques et de solutions numeriques fiables. Avec une experience concrete en design et en developpement, j'ai livre plus de 50 projets en gardant la performance, l'ergonomie et une execution propre au centre de mon travail.",
    ...
    workCard5Title: "Hub d'Outils",
    workDemoButton: "Demo <i class='bx bx-right-arrow work__icon'></i>",
    workToolsButton: "Explorer <i class='bx bx-right-arrow work__icon'></i>",
    toolsSpotlightEyebrow: "Boite a outils navigateur",
    toolsSpotlightTitle: "Hub d'Outils",
    toolsSpotlightText:
      "Des outils PDF, image, developpement, texte et utilitaires rapides qui tournent localement dans votre navigateur.",
    toolsSpotlightLive: "Outils en ligne",
    toolsSpotlightPages: "Pages statiques",
    toolsSpotlightButton: "Ouvrir le hub",
  ...
  ar: {
    ...
    aboutCompletedSubtitle: "50+ مشاريع",
    aboutSupportTitle: "الدعم",
    aboutSupportSubtitle: "متاح 24/7",
    aboutDescription:
      "انا مهندس برمجيات اركز على بناء تجارب ويب متقنة، وتطبيقات سطح مكتب عملية، وحلول رقمية موثوقة. ومع خبرة عملية في التصميم والتطوير، انجزت اكثر من 50 مشروعا مع الحفاظ على الاداء وسهولة الاستخدام والتنفيذ النظيف في صميم عملي.",
    ...
    workCard5Title: "مركز أدوات المتصفح",
    workToolsButton: "استكشف <i class='bx bx-right-arrow work__icon'></i>",
    toolsSpotlightEyebrow: "أدوات تعمل في المتصفح",
    toolsSpotlightTitle: "مركز أدوات المتصفح",
    toolsSpotlightText:
      "أدوات PDF والصور والتطوير والنصوص والأدوات المساعدة تعمل محليا في متصفحك.",
    toolsSpotlightLive: "أدوات حية",
    toolsSpotlightPages: "صفحات أدوات ثابتة",
    toolsSpotlightButton: "افتح مركز الأدوات",
